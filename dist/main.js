...
/* harmony import */ var _burger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./burger */ "./assets/scripts/burger.js");
  ...
  if (inputEl) {
    var transformJson = function transformJson(json) {
      return json.map(function (el) {
        return "<li class=\"\"><a class='' href='".concat(el.permalink, "'>").concat(el.label, "</a></li>");
      }).join("");
    };
...
document.addEventListener("DOMContentLoaded", function () {
  var open_menu = document.querySelector(".open-mobile");
  var open_menu_side = document.querySelector(".open-mobile-side");
  var menu_mobile = document.querySelector(".menu-mobile");
  var close_menu = document.querySelector(".close-mobile");
  ...
  close_menu === null || close_menu === void 0 ? void 0 : close_menu.addEventListener("click", close);
  open_menu === null || open_menu === void 0 ? void 0 : open_menu.addEventListener("click", open);
  open_menu_side === null || open_menu_side === void 0 ? void 0 : open_menu_side.addEventListener("click", open); // if (window.scrollY > header.offsetHeight + 150) {
